...
class Document(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    lab_measurements: Mapped[list[LabMeasurement]] = relationship(
        back_populates="document",
        cascade="all, delete-orphan",
        passive_deletes=True,
    )
...
class DocumentMetadata(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    medicines: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
    procedures: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
    allergies: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
    medical_devices: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
    vaccinations: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
...
class AISummary(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    important_dates: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
    highlights: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
